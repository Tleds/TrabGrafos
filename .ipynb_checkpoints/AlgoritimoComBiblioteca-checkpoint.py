...
M_W = input('Digite Quantidade Computadores e fios: ') #obtem o numero de computadores e fios
...
M = int(M_W.split(' ')[0]) #Split para pegar a quantidade de Computadores (Machine) 
W = int(M_W.split(' ')[1]) #Split para pegar a quantidade de Fios (Wires)
